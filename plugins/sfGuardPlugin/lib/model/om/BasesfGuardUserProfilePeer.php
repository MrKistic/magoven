...
abstract class BasesfGuardUserProfilePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'FirstName', 'LastName', 'Email', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'firstName', 'lastName', 'email', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::FIRST_NAME, self::LAST_NAME, self::EMAIL, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'first_name', 'last_name', 'email', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'FirstName' => 2, 'LastName' => 3, 'Email' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'firstName' => 2, 'lastName' => 3, 'email' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::FIRST_NAME => 2, self::LAST_NAME => 3, self::EMAIL => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'first_name' => 2, 'last_name' => 3, 'email' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
