...
abstract class BasesfGuardUserForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'username'                      => new sfValidatorString(array('max_length' => 128, 'required' => true)),
      'algorithm'                     => new sfValidatorString(array('max_length' => 128, 'required' => true)),
      'salt'                          => new sfValidatorString(array('max_length' => 128, 'required' => true)),
      'password'                      => new sfValidatorString(array('max_length' => 128, 'required' => true)),
      'created_at'                    => new sfValidatorDateTime(array('required' => false)),
      'last_login'                    => new sfValidatorDateTime(array('required' => false)),
      'is_active'                     => new sfValidatorBoolean(array('required' => true)),
      'is_super_admin'                => new sfValidatorBoolean(array('required' => true)),
