...
abstract class BasePurchasePeer {
	...
	const APPLICATION_ID = 'purchase.APPLICATION_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'CreatedAt', 'UpdatedAt', 'ApplicationId', 'UserId', 'ProductId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'createdAt', 'updatedAt', 'applicationId', 'userId', 'productId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CREATED_AT, self::UPDATED_AT, self::APPLICATION_ID, self::USER_ID, self::PRODUCT_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'created_at', 'updated_at', 'application_id', 'user_id', 'product_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'CreatedAt' => 1, 'UpdatedAt' => 2, 'ApplicationId' => 3, 'UserId' => 4, 'ProductId' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'createdAt' => 1, 'updatedAt' => 2, 'applicationId' => 3, 'userId' => 4, 'productId' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CREATED_AT => 1, self::UPDATED_AT => 2, self::APPLICATION_ID => 3, self::USER_ID => 4, self::PRODUCT_ID => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'created_at' => 1, 'updated_at' => 2, 'application_id' => 3, 'user_id' => 4, 'product_id' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PurchasePeer::APPLICATION_ID);
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BasePurchasePeer', $criteria, $con);
		}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePurchasePeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePurchasePeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePurchasePeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasePurchasePeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePurchasePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasePurchasePeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasePurchasePeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasePurchasePeer', $values, $con, $ret);
    }
	...
	{
	  return array(array('application_id', 'user_id', 'product_id'));
	}
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BasePurchasePeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
