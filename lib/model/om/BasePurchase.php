...
abstract class BasePurchase extends BaseObject  implements Persistent {
	...
	public function setApplicationId($v)
	{
		...
		if ($this->application_id !== $v) {
			...
			$this->modifiedColumns[] = PurchasePeer::APPLICATION_ID;
		}
	...
	public function setProductId($v)
	{
		...
		if ($this->product_id !== $v || $this->isNew()) {
			$this->product_id = $v;
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BasePurchase:delete:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BasePurchase:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BasePurchase:save:pre') as $callable)
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(PurchasePeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BasePurchase:save:post') as $callable)
				{
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PurchasePeer::APPLICATION_ID)) $criteria->add(PurchasePeer::APPLICATION_ID, $this->application_id);
	...
	{
	  if (!$callable = sfMixer::getCallable('BasePurchase:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BasePurchase::%s', $method));
	  }
