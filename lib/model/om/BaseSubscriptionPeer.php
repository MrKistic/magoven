...
abstract class BaseSubscriptionPeer {
	...
	const UPDATED_AT = 'subscription.UPDATED_AT';

	/** the column name for the APPLICATION_ID field */
	const APPLICATION_ID = 'subscription.APPLICATION_ID';

	/** the column name for the USER_ID field */
	const USER_ID = 'subscription.USER_ID';

	/** the column name for the EFFECTIVE_DATE field */
	const EFFECTIVE_DATE = 'subscription.EFFECTIVE_DATE';

	/** the column name for the EXPIRATION_DATE field */
	const EXPIRATION_DATE = 'subscription.EXPIRATION_DATE';

	/** the column name for the LAST_VALIDATED field */
	const LAST_VALIDATED = 'subscription.LAST_VALIDATED';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'CreatedAt', 'UpdatedAt', 'ApplicationId', 'UserId', 'EffectiveDate', 'ExpirationDate', 'LastValidated', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'createdAt', 'updatedAt', 'applicationId', 'userId', 'effectiveDate', 'expirationDate', 'lastValidated', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CREATED_AT, self::UPDATED_AT, self::APPLICATION_ID, self::USER_ID, self::EFFECTIVE_DATE, self::EXPIRATION_DATE, self::LAST_VALIDATED, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'created_at', 'updated_at', 'application_id', 'user_id', 'effective_date', 'expiration_date', 'last_validated', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'CreatedAt' => 1, 'UpdatedAt' => 2, 'ApplicationId' => 3, 'UserId' => 4, 'EffectiveDate' => 5, 'ExpirationDate' => 6, 'LastValidated' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'createdAt' => 1, 'updatedAt' => 2, 'applicationId' => 3, 'userId' => 4, 'effectiveDate' => 5, 'expirationDate' => 6, 'lastValidated' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CREATED_AT => 1, self::UPDATED_AT => 2, self::APPLICATION_ID => 3, self::USER_ID => 4, self::EFFECTIVE_DATE => 5, self::EXPIRATION_DATE => 6, self::LAST_VALIDATED => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'created_at' => 1, 'updated_at' => 2, 'application_id' => 3, 'user_id' => 4, 'effective_date' => 5, 'expiration_date' => 6, 'last_validated' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(SubscriptionPeer::APPLICATION_ID);
		$criteria->addSelectColumn(SubscriptionPeer::USER_ID);
		$criteria->addSelectColumn(SubscriptionPeer::EFFECTIVE_DATE);
		$criteria->addSelectColumn(SubscriptionPeer::EXPIRATION_DATE);
		$criteria->addSelectColumn(SubscriptionPeer::LAST_VALIDATED);
	}
