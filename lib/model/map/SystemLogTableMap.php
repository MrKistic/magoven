...
class SystemLogTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.SystemLogTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('LOG_TYPE', 'LogType', 'VARCHAR', false, 25, null);
		$this->addColumn('MESSAGE', 'Message', 'LONGVARCHAR', false, null, null);
		$this->addColumn('APPLICATION_ID', 'ApplicationId', 'VARCHAR', false, 255, null);
